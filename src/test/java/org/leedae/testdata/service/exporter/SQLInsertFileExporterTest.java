...
@DisplayName("[Logic] SQL INSERT 파일 출력기 테스트")
@ExtendWith(MockitoExtension.class)
class SQLInsertFileExporterTest {

    @InjectMocks private SQLInsertFileExporter sut;
    @Mock private MockDataGeneratorContext mockDataGeneratorContext;

    @DisplayName("테이블 스키마 정보와 행 수가 주어지면, SQL INSERT 형식의 문자열을 생성한다.")
    @Test
    void givenSchemaAndRowCount_whenExporting_thenReturnsSQLInsertFormattedString(){
        // Given
        ExportFileType exportFileType = ExportFileType.SQL_INSERT;
        ...
        // Then
        assertThat(result).contains("INSERT INTO test_schema");
