...
/**
 * 특정 {@link MockDataType} 가짜 데이터 자료형에 대응하는 가짜 데이터.
 * 알고리즘으로 생성하지 않는 {@link MockDataType} 경우, 이 가짜 데이터를 랜덤으로 뽑아 출력한다.
 * @author lee
 */
@Getter
@ToString
...
public class MockData {
    ...
    public MockData(MockDataType mockDatType, String mockDataValue) {
        this.mockDataType = mockDatType;
