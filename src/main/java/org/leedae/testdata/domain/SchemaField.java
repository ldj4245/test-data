...
public class SchemaField extends AuditingFields {
    ...
    public static SchemaField of(String fieldName, MockDataType mockDateType, Integer fieldOrder, Integer blankPercent, String typeOptionJson, String forceValue) {
        return new SchemaField(fieldName, mockDateType, fieldOrder, blankPercent, typeOptionJson, forceValue);
    }
