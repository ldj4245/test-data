...
public record TableSchemaDto(
    ...
    public static TableSchemaDto fromEntity(TableSchema entity) {
        return new TableSchemaDto(
                ...
                entity.getSchemaFields().stream().map(SchemaFieldDto::fromEntity).collect(Collectors.toUnmodifiableSet()),
                entity.getCreatedAt(),
                entity.getCreatedBy(),
    ...
    public TableSchema createEntity() {
        ...
        entity.addSchemaFields(schemaFields.stream().map(SchemaFieldDto::createdEntity).toList());
        return entity;
    }
